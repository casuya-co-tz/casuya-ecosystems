import { ContentItem, ContentSummary, ContentRepositoryConfig, PaginationOptions, PaginatedResult } from '../../interfaces';

export interface IContentRepositoryProvider {
